# ---
# Name: Salaire net par tranche de salaire par catégories Rente
# Short Name: SN_rente
# Type: benefit
# ---
...
if r1_as_r2 and categorie == 'r1':
    ...
    tauxTA_r1 = param_1_pourcentage_ta_r1_SN()
...
for date_debut, date_fin, periode_entiere, prorata, unit in periodes:
    ...
    rente_de_base_periode, annexe_description = rule_prestations_annexes_rente(
        ...
        rente_ss_reellement_percue=compl_rente_SS_percue_prestations_annexes(), salaire_de_reference_net=salaire_de_reference_periode) 

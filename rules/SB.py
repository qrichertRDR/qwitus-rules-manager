# ---
# Name: Salaire brut par tranche de salaire
# Short Name: SB
# Type: benefit
# ---
...
salaire_reference_journalier = arrondir((arrondir(tranches['TA'], 0.01)+arrondir(tranches['TB'], 0.01)+ arrondir(tranches['TC'], 0.01)) / 365, 0.01)

...
# Short Name: salaire_brut_par_tranche_de_salaire_selon_nb_d_enfant_a_charge
# Type: benefit
# ---
...
if nb_enfant_a_charge == 0:
    pourcentage_TA = param_1_pourcentage_ij_ta_sans_enfant_a_charge()
    pourcentage_TB = param_1_pourcentage_ij_tb_sans_enfant_a_charge()
    pourcentage_TC = param_1_pourcentage_ij_tc_sans_enfant_a_charge()
elif nb_enfant_a_charge == 1:
    pourcentage_TA = param_2_pourcentage_ij_ta_avec_1_enfant_a_charge()
    pourcentage_TB = param_2_pourcentage_ij_tb_avec_1_enfant_a_charge()
    pourcentage_TC = param_2_pourcentage_ij_tc_avec_1_enfant_a_charge()
elif nb_enfant_a_charge == 2:
    pourcentage_TA = param_3_pourcentage_ij_ta_avec_2_enfants_a_charge()
    pourcentage_TB = param_3_pourcentage_ij_tb_avec_2_enfants_a_charge()
    pourcentage_TC = param_3_pourcentage_ij_tc_avec_2_enfants_a_charge()
elif nb_enfant_a_charge >= 3:
    pourcentage_TA = param_4_pourcentage_ij_ta_plus_de_3_enfants_a_charge()
    pourcentage_TB = param_4_pourcentage_ij_tb_plus_de_3_enfants_a_charge()
    pourcentage_TC = param_4_pourcentage_ij_tc_plus_de_3_enfants_a_charge()
...
print limite, salaire_journalier + IJSS

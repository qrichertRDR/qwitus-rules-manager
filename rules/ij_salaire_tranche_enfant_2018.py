# ---
# Name: Indemnité Journalière selon enfant (nouveau)
# Short Name: ij_salaire_tranche_enfant_2018
# Type: benefit
# ---
...
def ij_enfant():
    ...
    :données complémentaires:
        ...
        - sanction_ijss
        - ib_corrigee
        - nombre_d_enfants_a_charge
    :return:
    :rtype: list[dict[str,any]]
    '''

    def specificites_enfant():
        ...
        pcts_base_av_rup_enfant = param_a02b_pcts_base_av_rup_enfant()
        pcts_base_av_rup_enfant = pcts_base_av_rup_enfant.split(caractere_separateur_classes) # %TA/%TB/%TC$%TA/%TB/%TC$...

        pcts_base_ap_rup_enfant = param_a03b_pcts_base_ap_rup_enfant()
        ...
        return [
            complement, classes_enfant, base_av_rup, pcts_base_av_rup,
            base_ap_rup, pcts_base_ap_rup, type_deduction_recccn
        ]
    ...
    # SPECIF
    res = specificites_enfant()
    if res is None:
        return

    complement, classes_enfant, base_av_rup, pcts_base_av_rup, base_ap_rup, \
        pcts_base_ap_rup, type_deduction_recccn = res
...
return ij_enfant() # DECOMMENTER SOUS COOG

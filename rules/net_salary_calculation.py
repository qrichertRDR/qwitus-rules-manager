# ---
# Name: Calcul du salaire NET (Imposable)
# Short Name: net_salary_calculation
...
def salaire_net_fiscal():
    '''
    Nom : Calcul du salaire NET (Imposable)
    Code : net_salary_calculation
    Type : Prestation: Calcul du salaire net
    Type du résultat :
    Contexte : Context par défaut
    Statut : Validé
    '''
    net_sans_prime = salaire_type_net('net_fiscal', False)
    net_avec_prime = salaire_type_net('net_fiscal')
    prime_net = net_avec_prime - net_sans_prime
    return net_sans_prime, prime_net

return salaire_net_fiscal() # DECOMMENTER NET FISCAL

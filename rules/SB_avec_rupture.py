# ---
# Name: Salaire brut par tranche de salaire avec salaire net en cas de rupture
# Short Name: SB_avec_rupture
# Type: benefit
# ---
...
pourcentage_TA = param_1_pourcentage_ij_ta_SB_rupture() if not rupture else param_2_pourcentage_ij_ta_apres_rupture()
pourcentage_TB = param_1_pourcentage_ij_tb_SB_rupture() if not rupture else param_2_pourcentage_ij_tb_apres_rupture()
pourcentage_TC = param_1_pourcentage_ij_tc_SB_rupture() if not rupture else param_2_pourcentage_ij_tc_apres_rupture()
if pourcentage_TA:

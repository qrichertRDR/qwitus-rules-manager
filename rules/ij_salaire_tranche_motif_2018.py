# ---
# Name: Indemnité Journalière selon motif (nouveau)
# Short Name: ij_salaire_tranche_motif_2018
# Type: benefit
# ---
...
def ij_motif():
    ...
    def specificites():
        ...
        pct_base_av_rup_mal_pro = param_a02b_pcts_base_av_rup_mal_pro()  # TA/TB/TC
        pcts_base_av_rup_mal_ord = param_a02b_pcts_base_av_rup_mal_ord()
        pcts_base_av_rup_acc_pro = param_a02b_pcts_base_av_rup_acc_pro()
        pcts_base_av_rup_acc_vp = param_a02b_pcts_base_av_rup_acc_vp()
        pcts_base_av_rup_mat = param_a02b_pcts_base_av_rup_mat()

        base_ap_rup = param_a03a_base_ap_rup()
        pcts_base_ap_rup_mal_pro = param_a03b_pcts_base_ap_rup_mal_pro()  # TA/TB/TC
        pcts_base_ap_rup_mal_ord = param_a03b_pcts_base_ap_rup_mal_ord()
        pcts_base_ap_rup_acc_pro = param_a03b_pcts_base_ap_rup_acc_pro()
        pcts_base_ap_rup_acc_vp = param_a03b_pcts_base_ap_rup_acc_vp()
        pcts_base_ap_rup_mat = param_a03b_pcts_base_ap_rup_mat()
        ...
        pcts_base_av_rup = selecteur_motif_vers_valeur(pcts_base_av_rup_mat, pcts_base_av_rup_acc_pro,
                                                       pcts_base_av_rup_acc_vp, pct_base_av_rup_mal_pro,
                                                       pcts_base_av_rup_mal_ord, motif_arret)

        pcts_base_ap_rup = selecteur_motif_vers_valeur(pcts_base_ap_rup_mat, pcts_base_ap_rup_acc_pro,
                                                       pcts_base_ap_rup_acc_vp, pcts_base_ap_rup_mal_pro,
                                                       pcts_base_ap_rup_mal_ord, motif_arret)
    ...
    complement, base_av_rup, pcts_base_av_rup, base_ap_rup, pcts_base_ap_rup, \
        type_deduction_recccn = specificites()
...
return ij_motif() # DECOMMENTER SOUS COOG

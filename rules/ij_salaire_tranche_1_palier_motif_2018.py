# ---
# Name: Indemnité Journalière selon 1 palier et motif (nouveau)
# Short Name: ij_salaire_tranche_1_palier_motif_2018
# Type: benefit
# ---
...
def ij_un_palier_motif():

    def specificites_palier_motif():
        ...
        # GESTION PALIER X MOTIF
        pct_base_av_rup_mal_pro_0 = param_a02b_pcts_base_av_rup_mal_pro_0()  # TA/TB/TC
        pcts_base_av_rup_mal_ord_0 = param_a02b_pcts_base_av_rup_mal_ord_0()
        pcts_base_av_rup_acc_pro_0 = param_a02b_pcts_base_av_rup_acc_pro_0()
        pcts_base_av_rup_acc_vp_0 = param_a02b_pcts_base_av_rup_acc_vp_0()
        pcts_base_av_rup_mat_0 = param_a02b_pcts_base_av_rup_mat_0()

        pcts_base_ap_rup_mal_pro_0 = param_a03b_pcts_base_ap_rup_mal_pro_0()  # TA/TB/TC
        pcts_base_ap_rup_mal_ord_0 = param_a03b_pcts_base_ap_rup_mal_ord_0()
        pcts_base_ap_rup_acc_pro_0 = param_a03b_pcts_base_ap_rup_acc_pro_0()
        pcts_base_ap_rup_acc_vp_0 = param_a03b_pcts_base_ap_rup_acc_vp_0()
        pcts_base_ap_rup_mat_0 = param_a03b_pcts_base_ap_rup_mat_0()

        pct_base_av_rup_mal_pro_1 = param_a02b_pcts_base_av_rup_mal_pro_1()  # TA/TB/TC
        pcts_base_av_rup_mal_ord_1 = param_a02b_pcts_base_av_rup_mal_ord_1()
        pcts_base_av_rup_acc_pro_1 = param_a02b_pcts_base_av_rup_acc_pro_1()
        pcts_base_av_rup_acc_vp_1 = param_a02b_pcts_base_av_rup_acc_vp_1()
        pcts_base_av_rup_mat_1 = param_a02b_pcts_base_av_rup_mat_1()

        pcts_base_ap_rup_mal_pro_1 = param_a03b_pcts_base_ap_rup_mal_pro_1()  # TA/TB/TC
        pcts_base_ap_rup_mal_ord_1 = param_a03b_pcts_base_ap_rup_mal_ord_1()
        pcts_base_ap_rup_acc_pro_1 = param_a03b_pcts_base_ap_rup_acc_pro_1()
        pcts_base_ap_rup_acc_vp_1 = param_a03b_pcts_base_ap_rup_acc_vp_1()
        pcts_base_ap_rup_mat_1 = param_a03b_pcts_base_ap_rup_mat_1()

        pcts_base_av_rup_0 = selecteur_motif_vers_valeur(
            pcts_base_av_rup_mat_0, pcts_base_av_rup_acc_pro_0,
            pcts_base_av_rup_acc_vp_0, pct_base_av_rup_mal_pro_0,
            pcts_base_av_rup_mal_ord_0, motif_arret)

        pcts_base_av_rup_1 = selecteur_motif_vers_valeur(
            pcts_base_av_rup_mat_1, pcts_base_av_rup_acc_pro_1,
            pcts_base_av_rup_acc_vp_1, pct_base_av_rup_mal_pro_1,
            pcts_base_av_rup_mal_ord_1, motif_arret)

        pcts_base_ap_rup_0 = selecteur_motif_vers_valeur(
            pcts_base_ap_rup_mat_0, pcts_base_ap_rup_acc_pro_0,
            pcts_base_ap_rup_acc_vp_0, pcts_base_ap_rup_mal_pro_0,
            pcts_base_ap_rup_mal_ord_0, motif_arret)

        pcts_base_ap_rup_1 = selecteur_motif_vers_valeur(
            pcts_base_ap_rup_mat_1, pcts_base_ap_rup_acc_pro_1,
            pcts_base_ap_rup_acc_vp_1, pcts_base_ap_rup_mal_pro_1,
            pcts_base_ap_rup_mal_ord_1, motif_arret)
    ...
    resultats = ij_un_palier(specificites_palier_motif)
    si_erreur_lever_erreur(resultats)

    return resultats

return ij_un_palier_motif() # DECOMMENTER SOUS COOG

# ---
# Name: Eligibilité emprunteur R2/3
# Short Name: eligibilite_prestation_emprunteur_r2_3
# Type: benefit
# ---
...
def eligibilite_emprunteur_r2_r3():

    test_delai_declaration = gestion_delai_declaration_als()
    if not test_delai_declaration:
        return test_delai_declaration

    test_categorie_rente = gestion_categorie_rente(['r2', 'r3'])
    return test_categorie_rente

return eligibilite_emprunteur_r2_r3() # DECOMMENTER EL EMP R2 R3

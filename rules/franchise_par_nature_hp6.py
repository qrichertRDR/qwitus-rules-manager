# ---
# Name: Franchise selon la nature de l'arrêt HP6
# Short Name: franchise_par_nature_hp6
# Type: benefit_deductible
# ---

evenement = code_de_l_evenement_du_prejudice()
if nombre_jours_hospitalisation_prejudice() > 0 and nombre_jours_hospitalisation_prejudice() < 6:
    nb_jour = param_6_franchise_en_cas_d_hospitalisation()
elif nombre_jours_hospitalisation_prejudice() >= 6:
    nb_jour = 0
